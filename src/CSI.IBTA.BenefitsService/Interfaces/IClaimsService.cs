...
namespace CSI.IBTA.BenefitsService.Interfaces
{
    public interface IClaimsService
    {
        ...
        Task<GenericResponse<PagedClaimsResponse>> GetClaims(int page, int pageSize, byte[]? encodedEmployerEmployee, string claimNumber = "", string employerId = "", string employeeId = "", string claimStatus = "");
