...
{
    public record UserDto(int Id, Role Role, string UserName, string FirstName, string LastName, int AccountId, int? EmployerId, string EmailAddress, string PhoneNumber, string? SSN);
