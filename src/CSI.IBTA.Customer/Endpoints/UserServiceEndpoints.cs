namespace CSI.IBTA.Customer.Endpoints
{
    public class UserServiceEndpoints
    {
        ...
        public const string EncryptedEmployeeSettings = "v1/Encrypt/Employer/{0}/Employee/{1}/Settings";
        ...
        public const string GetClaimFillingSetting = "v1/Employee/{0}/ClaimFilling";
